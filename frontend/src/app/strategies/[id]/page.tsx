...
import { formatPrice, formatSymbol, quoteAsset, formatDateTime, parseUTCTimestamp } from "@/lib/utils";
                          ...
                          <div className="flex flex-wrap gap-4 items-center">
                            ...
                            <div className="flex gap-6 text-sm">
                              ...
                              <div>
                                ...
                                <span>{pos.quantity.toFixed(4)} {quoteAsset(pos.symbol)}</span>
                              </div>
                            ...
                            <tbody>
                              {posHistory.map((pos) => (
                                <tr key={pos.id} className="border-b border-slate-800 last:border-0">
                                  ...
                                  <td className="p-4">{pos.quantity.toFixed(4)} {quoteAsset(pos.symbol)}</td>
                                  <td className="p-4 text-right">
                                    {pos.pnl != null ? (
